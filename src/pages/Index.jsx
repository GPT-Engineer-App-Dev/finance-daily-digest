    ...
    <Container maxW="container.xl" p={0}>
      ...
      <Box bg="gray.800" color="white" py={4}>
        <Flex justify="space-between" align="center" maxW="container.xl" mx="auto" px={4}>
          ...
          <HStack spacing={8}>
            ...
            <Link href="#" _hover={{ textDecoration: "none", color: "gray.400" }}>Companies</Link>
            <Link href="#" _hover={{ textDecoration: "none", color: "gray.400" }}>Economy</Link>
      ...
      <Flex direction={{ base: "column", md: "row" }} mt={8} px={4}>
        ...
        <Box flex="3" mr={{ md: 8 }}>
          ...
          {/* Recent Articles */}
          <Box>
            <Heading as="h3" size="lg" mb={4}>Recent Articles</Heading>
            <VStack spacing={4} align="stretch">
              <Box p={4} borderWidth="1px" borderRadius="md">
                <Heading as="h4" size="md">Article Title 1</Heading>
                <Text mt={2}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</Text>
              </Box>
              <Box p={4} borderWidth="1px" borderRadius="md">
                <Heading as="h4" size="md">Article Title 2</Heading>
                <Text mt={2}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</Text>
              </Box>
              <Box p={4} borderWidth="1px" borderRadius="md">
                <Heading as="h4" size="md">Article Title 3</Heading>
                <Text mt={2}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</Text>
              </Box>
            </VStack>
          </Box>
